...
public class TestUserService {
	...
	public static void main(String[] args) throws WebshopAppException {
		...
		UserModel user2 = new UserModel.Builder("Test@test.se", "123", "Test",
				"Testson", "Stockholmsv. 32", "Stockholm", "postcode")
				.address2("C/O Olsen").dob("1949-09-09")
				.telephone("0807384756").build();
		service.addUser(user2);
		System.out.println(service.getUser("test@test.se"));
		UserModel updatedUser2 = new UserModel.Builder("Test@test.se", "123",
				"Test", "Testson", "Stockholmsv. 32", "Stockholm", "postcode")
				.address2("C/O Olsen").dob("1949-09-09")
				.telephone("0807384756").build();
		...
		try {
			...
			System.err.println("Exception: " + e.getActionName() + ": "
					+ e.getMessage() + " - " + e.getClassName());
		}
		...
		Map<Integer, Integer> shoppingCart = service
				.getShoppingCartContents(user3);
