	...
	private static void editInformation()
	{
		...
		case 1:
			...
			case 1:
				try
				{
					productMenu.productCreated(productService.createProduct(productMenu.createProduct()));
				}
			...
			case 4:
				try
				{
					System.out.println(productService.getProductById(productMenu.getProduct()));
				}
		...
		case 2:
			...
			case 1:
				try
				{
					categoryMenu.addedCategory(categoryService.addCategory(categoryMenu.addCategory()));
				}
				catch (WebshopAppException e)
				{
					// TODO Auto-generated catch block
			...
			case 4:
				try
				{
					categoryMenu.foundCategory(categoryService.searchCategoryByName(categoryMenu.getCategory()));
				}
				catch (WebshopAppException e1)
				{
					e1.printStackTrace();
		...
		case 3:
			...
			case 2:
				try
				{
					System.out.println(userMenu.updateUser(userService.getUser(userMenu.askForEmail())));
				}
				catch (WebshopAppException e1)
				{
					e1.printStackTrace();
