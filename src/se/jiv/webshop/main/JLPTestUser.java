...
public final class JLPTestUser {
	...
	public static void main(String[] args) {
		...
		//addProductToCart
		test9(userService);
		test10(userService); System.out.println("NOOOOOOOOO OK TEST 10 --> exception");
		test11(userService); System.out.println("NOOOOOOOOO OK TEST 11 --> exception");
	...
	private static void test18(UserService userService) {
		try {
			...
			System.out.println("TEST 18 -->RESULT: " + sc.get(1) +" OK if Result=4, NOK other value");
	...
	private static void test16(UserService userService) {
		try {
			UserModel user = new UserModel(null, null, null, null, null, null,
					null, null, null, null);
			userService.removeFromCart(user, -1, 2);
		} catch (WebshopAppException e) {
		} catch (Exception e1) {
